 ...
 * ```
 */
export declare function standardSchemaResolver<TFieldValues extends FieldValues, Schema extends StandardSchemaV1<TFieldValues, any>>(schema: Schema, resolverOptions?: {
    raw?: boolean;
